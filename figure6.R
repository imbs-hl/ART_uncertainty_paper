#' With this script the figure 6 from Kronziel et al. "Uncertainty 
...
# save plot
ggsave(plot_width, filename = file.path(out_dir, "fig6_benchmark_interval_width.png"), width = 30, height = 15, units = "cm", dpi = 200)
